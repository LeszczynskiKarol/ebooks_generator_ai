// i18n strings for: projectDetail  (keys prefixed "projectDetail.")
export const en: Record<string, string> = {
  // flow steps
  "projectDetail.step.payment": "Payment",
  "projectDetail.step.structure": "Structure",
  "projectDetail.step.review": "Review",
  "projectDetail.step.writing": "Writing",
  "projectDetail.step.compiling": "Compiling",
  "projectDetail.step.done": "Done",
  // header / nav
  "projectDetail.backToDashboard": "Back to Dashboard",
  "projectDetail.coverAlt": "Book cover",
  // progress
  "projectDetail.progress": "Progress",
  // details card
  "projectDetail.details": "Details",
  "projectDetail.pages": "Pages",
  "projectDetail.language": "Language",
  "projectDetail.style": "Style",
  ...
  // edit content
  "projectDetail.editBookContent": "Edit Book Content",
...
export const pl: Record<string, string> = {
  // flow steps
  "projectDetail.step.payment": "Płatność",
  "projectDetail.step.structure": "Struktura",
  "projectDetail.step.review": "Przegląd",
  "projectDetail.step.writing": "Pisanie",
  "projectDetail.step.compiling": "Składanie",
  "projectDetail.step.done": "Gotowe",
  // header / nav
  "projectDetail.backToDashboard": "Powrót do panelu",
  "projectDetail.coverAlt": "Okładka książki",
  // progress
  "projectDetail.progress": "Postęp",
  // details card
  "projectDetail.details": "Szczegóły",
  "projectDetail.pages": "Strony",
  "projectDetail.language": "Język",
  "projectDetail.style": "Styl",
  "projectDetail.format": "Format",
  // payment card
  ...
  // edit content
  "projectDetail.editBookContent": "Edytuj treść książki",
