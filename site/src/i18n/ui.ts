...
export const ui = {
  en: {
    ...
    valueAnchor: {
      ...
      items: [
        { label: "AI “book” generators", cost: "$30–90 / month", note: "A subscription — and they hand you a raw draft you still have to format yourself." },
        { label: "Typesetting tools (Atticus, Vellum)", cost: "$147–250 once", note: "Only format a finished manuscript — you still have to write the whole book." },
        { label: "Freelance formatting", cost: "$200–1,000 / book", note: "Per book, every time. A designed cover is extra on top." },
        { label: "A ghostwriter + a cover designer", cost: "$1,000s", note: "Weeks of back-and-forth for a single finished book." },
      ],
      usLabel: "InkMagnet",
      usPre: "from",
      usNote: "Research, writing, review, typesetting, cover, PDF + EPUB — one payment, full commercial rights, no subscription.",
    ...
    pricing: {
      ...
      tiers: [
        ...
        { label: "Comprehensive", pages: "116–160", price: "$44.99", usd: 44.99 },
  ...
  pl: {
    ...
    valueAnchor: {
      ...
      items: [
        { label: "Generatory „książek” AI", cost: "120–360 zł / mies.", note: "Abonament — i oddają surowy draft, który i tak sam musisz złożyć." },
        { label: "Narzędzia do składu (Atticus, Vellum)", cost: "550–950 zł jednorazowo", note: "Tylko składają gotowy manuskrypt — całą książkę i tak piszesz sam." },
        { label: "Skład u freelancera", cost: "750–3700 zł / książkę", note: "Za każdą książkę osobno. Projekt okładki to dodatkowy koszt." },
        { label: "Ghostwriter + grafik od okładek", cost: "tysiące zł", note: "Tygodnie ustaleń dla jednej gotowej książki." },
      ],
      usLabel: "InkMagnet",
      usPre: "od",
      usNote: "Research, pisanie, recenzja, skład, okładka, PDF + EPUB — jedna opłata, pełne prawa komercyjne, bez abonamentu.",
